# verso-content-manager - Guide de Développement Forge

> **FICHIER GÉNÉRÉ PAR FORGE - NE JAMAIS MODIFIER**
> En cas de modification, régénérer avec: `forge regenerate-claude verso-content-manager`
> Ou via API: POST /api/skills/verso-content-manager/regenerate-claude
...
**IMPORTANT**: Votre code sera automatiquement validé par `curl -X POST http://10.0.0.13:4080/api/validate/verso-content-manager`
...
curl -X POST http://10.0.0.13:4080/api/validate/verso-content-manager | jq .
...
☐ curl -X POST http://10.0.0.13:4080/api/validate/verso-content-manager = valid: true
